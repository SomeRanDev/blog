...
// @ts-nocheck
var R=Object.defineProperty;var o=(t,e)=>{for(var u in e)R(t,u,{get:e[u],enumerable:!0})};import*as Z from"./_404.tsx";import*as ee from"./_app.tsx";import*as ne from"./blog.tsx";import*as ae from"./index.tsx";var h={};o(h,{default:()=>B,desc:()=>b,title:()=>x});import{Fragment as D,jsx as r,jsxs as l}from"https://esm.sh/v120/react@18.2.0/jsx-runtime";import{useMDXComponents as g}from"https://esm.sh/v120/@mdx-js/react@2.3.0";import{Head as A}from"aleph/react";import F from"~/components/BlogMeta.tsx";var x="About",b="This is a blog documenting the progress of my various projects. The large majority of which involve the Haxe programming language.";function f(t){let e=Object.assign({h1:"h1",p:"p",a:"a",blockquote:"blockquote"},g(),t.components);return l(D,{children:[r(A,{children:F({title:x,desc:b})}),`
