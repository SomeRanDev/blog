...
// @ts-nocheck
var R=Object.defineProperty;var o=(t,e)=>{for(var u in e)R(t,u,{get:e[u],enumerable:!0})};import*as ee from"./_404.tsx";import*as ne from"./_app.tsx";import*as ae from"./blog.tsx";import*as te from"./index.tsx";var h={};o(h,{default:()=>F,desc:()=>b,title:()=>x});import{Fragment as D,jsx as s,jsxs as l}from"https://esm.sh/v120/react@18.2.0/jsx-runtime";import{useMDXComponents as f}from"https://esm.sh/v120/@mdx-js/react@2.3.0";import{Head as A}from"aleph/react";import B from"~/components/BlogMeta.tsx";var x="About",b="This is a blog documenting the progress of my various projects. The large majority of which involve the Haxe programming language.";function g(t){let e=Object.assign({h1:"h1",p:"p",a:"a",blockquote:"blockquote"},f(),t.components);return l(D,{children:[s(A,{children:B({title:x,desc:b})}),`
...
`]}),`
`,s(e.p,{children:"Thanks for reading this! Hope you enjoy your stay."})]})}function P(t={}){let{wrapper:e}=Object.assign({},f(),t.components);return e?s(e,Object.assign({},t,{children:s(g,t)})):g(t)}var F=P;var d={};o(d,{default:()=>q,desc:()=>N,title:()=>w});import{Fragment as O,jsx as i,jsxs as k}from"https://esm.sh/v120/react@18.2.0/jsx-runtime";import{useMDXComponents as j}from"https://esm.sh/v120/@mdx-js/react@2.3.0";import{Head as X}from"aleph/react";import E from"~/components/BlogMeta.tsx";var w="About Reflaxe",N="Reflaxe is a Haxe framework for creating compilation targets using macros.";function y(t){let e=Object.assign({h1:"h1",p:"p",a:"a"},j(),t.components);return k(O,{children:[i(X,{children:E({title:w,desc:N})}),`
...
`,i("hr",{}),`
`,k(e.p,{children:["Check out more information here:",i("br",{}),`
`,i(e.a,{href:"https://github.com/RobertBorghese/reflaxe",children:"https://github.com/RobertBorghese/reflaxe"})]})]})}function L(t={}){let{wrapper:e}=Object.assign({},j(),t.components);return e?i(e,Object.assign({},t,{children:i(y,t)})):y(t)}var q=L;var m={};o(m,{default:()=>Y,desc:()=>S,title:()=>_});import{Fragment as $,jsx as n,jsxs as a}from"https://esm.sh/v120/react@18.2.0/jsx-runtime";import{useMDXComponents as v}from"https://esm.sh/v120/@mdx-js/react@2.3.0";import{Head as W}from"aleph/react";import U from"~/components/BlogMeta.tsx";import G from"~/components/BlogSubtext.tsx";var _="Reflaxe/C++ Devlog 1 - CallStack",S="A breakdown of the not-so-tedious process of making a call stack for my Haxe to C++ transpiler.";function C(t){let e=Object.assign({h1:"h1",h2:"h2",p:"p",code:"code",pre:"pre",span:"span",a:"a",em:"em",blockquote:"blockquote"},v(),t.components);return a($,{children:[n(W,{children:U({title:_,desc:S})}),`
`,n(e.h1,{id:"reflaxec-devlog-1---callstack",children:"Reflaxe/C++ Devlog #1 - CallStack"}),`
`,n(G,{link:"https://github.com/RobertBorghese/reflaxe.CPP",url:"https://api.github.com/repos/RobertBorghese/reflaxe.CPP",badgeUrl:"https://github.com/RobertBorghese/reflaxe.CPP/actions/workflows/main.yml/badge.svg",date:"May 15, 2023",author:"Robert Borghese"}),`
...
for future me!`}),`
`,n(e.p,{children:"Anyway, that's about it for this log. May you visit again!"})]})}function z(t={}){let{wrapper:e}=Object.assign({},v(),t.components);return e?n(e,Object.assign({},t,{children:n(C,t)})):C(t)}var Y=z;var p={};o(p,{default:()=>Z,desc:()=>M,title:()=>I});import{Fragment as J,jsx as r,jsxs as c}from"https://esm.sh/v120/react@18.2.0/jsx-runtime";import{useMDXComponents as H}from"https://esm.sh/v120/@mdx-js/react@2.3.0";import{Head as K}from"aleph/react";import V from"~/components/BlogMeta.tsx";var I="About Reflaxe/C++",M="Reflaxe/C++ is an alternative C++ target for Haxe that generates dependent-less, GC-less C++17 code.";function T(t){let e=Object.assign({h1:"h1",p:"p",strong:"strong",pre:"pre",code:"code",span:"span",a:"a"},H(),t.components);return c(J,{children:[r(K,{children:V({title:I,desc:M})}),`
